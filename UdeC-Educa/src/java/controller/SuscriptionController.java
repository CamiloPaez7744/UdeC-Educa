...
public class SuscriptionController implements Serializable {
    ...
    public Suscription getSelected() {
        if (current == null) {
            current = new Suscription();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (Suscription) getItems().getRowData();
    ...
    public static class SuscriptionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SuscriptionController controller = (SuscriptionController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "suscriptionController");
            return controller.getSuscription(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Suscription) {
                Suscription o = (Suscription) object;
                return getStringKey(o.getIdSuscription());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Suscription.class.getName());
            }
        }
