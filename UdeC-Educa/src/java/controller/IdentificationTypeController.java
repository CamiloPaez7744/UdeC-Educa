...
@Named("identificationTypeController")
@SessionScoped
public class IdentificationTypeController implements Serializable {
    ...
    public IdentificationType getSelected() {
        if (current == null) {
            current = new IdentificationType();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (IdentificationType) getItems().getRowData();
    ...
    public static class IdentificationTypeControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            IdentificationTypeController controller = (IdentificationTypeController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "identificationTypeController");
            return controller.getIdentificationType(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof IdentificationType) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + IdentificationType.class.getName());
            }
        }
