...
@Named("statusueController")
@SessionScoped
public class StatusueController implements Serializable {
    ...
    public StatusueController() {
    }

    public Statusue getSelected() {
        if (current == null) {
            current = new Statusue();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (Statusue) getItems().getRowData();
    ...
    public static class StatusueControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            StatusueController controller = (StatusueController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "statusueController");
            return controller.getStatusue(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Statusue) {
                Statusue o = (Statusue) object;
                return getStringKey(o.getIdStatus());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Statusue.class.getName());
            }
        }
